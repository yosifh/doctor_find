			...
			<nav class="navbar navbar-expand-lg header-nav">
				...
				<div class="main-menu-wrapper">
					...
					<ul class="main-nav">
						...
						<li>
							<a href="../form/add-docors.php" target="_blank">المسؤول</a>
						</li>
							...
							<div class="row align-items-center justify-content-center">
								...
								<div class="col-md-12 col-lg-6 login-right">
									<div class="login-header">
										<h3 style="text-align: center;">تسجيل طبيب جديد </h3>
									</div>
									...
									<form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post" >
										...
										<div class="form-group form-focus">
											...
											<label class="focus-label">أسم الطبيب</label>
										</div>
										<div class="form-group form-focus">
											<input type="text" id="phone" name="phone" class="form-control floating">
											<label class="focus-label">رقم الهاتف</label>
										</div>
										<div class="form-group form-focus">
											<input type="text" id="location" name="location" class="form-control floating">
											<label class="focus-label">موقع العيادة</label>
										</div>
										<div class="form-group form-focus">
											<input type="text" id="discription" name="discription" class="form-control floating">
											<label class="focus-label">وصف الطبيب</label>
										</div>
										<div class="form-group form-focus">
											<input type="text" id="nots" name="nots" class="form-control floating">
											<label class="focus-label">الملاحظات </label>
										</div>
										<div class="form-group form-focus">
											...
											<label class="focus-label">المدينة</label>
										</div>
										<div class="form-group form-focus">
											<select id="spec" name="spec" class="form-control floating">
											...
											<label class="focus-label"> التخصص الطبي</label>
										</div>
										
										<button class="btn btn-primary btn-block btn-lg login-btn" type="submit">تسجيل الطبيب</button>
