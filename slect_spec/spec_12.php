        ...
        <div class="banner-wrapper">
          <div class="banner-header text-center">
           ...
           echo"  <h1>أبحث عن أطباء  $specialty_name </h1>";
            echo"  <p>Discover the best doctors, clinic & hospital the city nearest to you.</p>";
            } else {
                  ...
                  <div class="col-md-6 col-lg-4 col-xl-3">
                    <div class="profile-widget">
                      ...
                      <div class="pro-content">
                        ...
                        <p class="speciality"><?php echo $spec_id; ?></p>

                        <ul class="available-info">
                          <li>
                            <i class="fas fa-map-marker-alt"></i> <?php echo $city_id; ?>
                          </li>


                          <li>
                            <i class="fas fa-info-circle" data-toggle="tooltip" title="<?php echo $discription; ?>"></i>
                          </li>
                        </ul>
